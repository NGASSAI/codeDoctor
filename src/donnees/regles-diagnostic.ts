...
export const REGLES_DIAGNOSTIC: RegleDiagnostic[] = [
  // ============================================================
  // JAVASCRIPT
  // ============================================================

  {
    ...
    explanation:
      "Une variable déclarée avec let ou const ne peut pas être utilisée avant sa déclaration.",
    cause:
...
console.log(nom);`,
...

  {
    ...
    explanation:
      "Une valeur peut être undefined au moment où le programme tente de l'utiliser.",
    cause:
...
console.log(utilisateur.nom);`,
...

  {
    ...
    severity: Severity.MOYENNE,
    explanation:
      "Une opération asynchrone peut échouer sans que son erreur soit correctement traitée.",
    cause:
...
const nouveauxUtilisateurs = [
...

  {
    ...
    severity: Severity.CRITIQUE,
    explanation:
      "Une condition logique peut toujours être vraie à cause d'une mauvaise expression.",
    cause:
...
if (role === "ADMIN" || role === "USER") {
...

  {
    ...
    severity: Severity.MOYENNE,
    explanation:
      "Le type any désactive une partie importante de la vérification statique de TypeScript.",
    cause:
      "Une valeur est déclarée avec any alors qu'un type plus précis pourrait être utilisé.",
    howToFind:
      "Recherchez les variables, paramètres ou retours explicitement typés any.",
    fixHint:
      "Définissez un type précis ou utilisez unknown lorsque le type est réellement inconnu.",
...
/>`,
  ...
  severity: Severity.CRITIQUE,
  explanation:
    "Une valeur est assignée à une variable qui n'a jamais été déclarée avec let, const ou var.",
  cause:
    "En mode strict (module ES, classes, ou 'use strict'), assigner une variable non déclarée provoque une ReferenceError à l'exécution.",
  howToFind:
    "Recherchez des assignations (nom = valeur) dont le nom n'apparaît jamais après let, const ou var.",
  fixHint:
    "Déclarez la variable avec let ou const avant de lui assigner une valeur.",
  beforeCode: `a = 2;
b = 4;
c = a + b;`,
  afterCode: `let a = 2;
