...
export type GetExerciseAttemptAggregateType<T extends ExerciseAttemptAggregateArgs> = {
    [P in keyof T & keyof AggregateExerciseAttempt]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateExerciseAttempt[P]> : Prisma.GetScalarType<T[P], AggregateExerciseAttempt[P]>;
};
...
export type GetExerciseAttemptGroupByPayload<T extends ExerciseAttemptGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ExerciseAttemptGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ExerciseAttemptGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ExerciseAttemptGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ExerciseAttemptGroupByOutputType[P]>;
}>>;
export type ExerciseAttemptWhereInput = {
    ...
    userAnswer?: Prisma.StringFilter<"ExerciseAttempt"> | string;
    correct?: Prisma.BoolFilter<"ExerciseAttempt"> | boolean;
    hintsUsed?: Prisma.IntFilter<"ExerciseAttempt"> | number;
...
export type ExerciseAttemptScalarWhereWithAggregatesInput = {
    ...
    userAnswer?: Prisma.StringWithAggregatesFilter<"ExerciseAttempt"> | string;
    correct?: Prisma.BoolWithAggregatesFilter<"ExerciseAttempt"> | boolean;
    hintsUsed?: Prisma.IntWithAggregatesFilter<"ExerciseAttempt"> | number;
...
export type ExerciseAttemptOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "exerciseId" | "userAnswer" | "correct" | "hintsUsed" | "createdAt", ExtArgs["result"]["exerciseAttempt"]>;
...
export type ExerciseAttemptCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ExerciseAttemptFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ExerciseAttemptDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['ExerciseAttempt'];
        meta: {
            name: 'ExerciseAttempt';
        };
    };
     ...
     * })
    **/
    count<T extends ExerciseAttemptCountArgs>(args?: Prisma.Subset<T, ExerciseAttemptCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ExerciseAttemptCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ExerciseAttemptGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ExerciseAttemptGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetExerciseAttemptGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface ExerciseAttemptFieldRefs {
    ...
    readonly userAnswer: Prisma.FieldRef<"ExerciseAttempt", 'String'>;
    readonly correct: Prisma.FieldRef<"ExerciseAttempt", 'Boolean'>;
    readonly hintsUsed: Prisma.FieldRef<"ExerciseAttempt", 'Int'>;
