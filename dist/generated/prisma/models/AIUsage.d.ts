...
export type GetAIUsageAggregateType<T extends AIUsageAggregateArgs> = {
    [P in keyof T & keyof AggregateAIUsage]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateAIUsage[P]> : Prisma.GetScalarType<T[P], AggregateAIUsage[P]>;
};
...
export type GetAIUsageGroupByPayload<T extends AIUsageGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<AIUsageGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof AIUsageGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], AIUsageGroupByOutputType[P]> : Prisma.GetScalarType<T[P], AIUsageGroupByOutputType[P]>;
}>>;
export type AIUsageWhereInput = {
    ...
    dateJour?: Prisma.StringFilter<"AIUsage"> | string;
    requetes?: Prisma.IntFilter<"AIUsage"> | number;
    tokensUtilises?: Prisma.IntFilter<"AIUsage"> | number;
    user?: Prisma.XOR<Prisma.UserScalarRelationFilter, Prisma.UserWhereInput>;
};
export type AIUsageOrderByWithRelationInput = {
    id?: Prisma.SortOrder;
    userId?: Prisma.SortOrder;
    dateJour?: Prisma.SortOrder;
    requetes?: Prisma.SortOrder;
    tokensUtilises?: Prisma.SortOrder;
    user?: Prisma.UserOrderByWithRelationInput;
};
export type AIUsageWhereUniqueInput = Prisma.AtLeast<{
    id?: string;
    userId_dateJour?: Prisma.AIUsageUserIdDateJourCompoundUniqueInput;
    AND?: Prisma.AIUsageWhereInput | Prisma.AIUsageWhereInput[];
    OR?: Prisma.AIUsageWhereInput[];
    NOT?: Prisma.AIUsageWhereInput | Prisma.AIUsageWhereInput[];
    userId?: Prisma.StringFilter<"AIUsage"> | string;
...
export type AIUsageScalarWhereWithAggregatesInput = {
    ...
    dateJour?: Prisma.StringWithAggregatesFilter<"AIUsage"> | string;
    requetes?: Prisma.IntWithAggregatesFilter<"AIUsage"> | number;
    tokensUtilises?: Prisma.IntWithAggregatesFilter<"AIUsage"> | number;
};
...
export type AIUsageUpdateInput = {
    ...
    dateJour?: Prisma.StringFieldUpdateOperationsInput | string;
    requetes?: Prisma.IntFieldUpdateOperationsInput | number;
    tokensUtilises?: Prisma.IntFieldUpdateOperationsInput | number;
...
export type AIUsageUserIdDateJourCompoundUniqueInput = {
    userId: string;
    dateJour: string;
};
...
export type AIUsageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "dateJour" | "requetes" | "tokensUtilises", ExtArgs["result"]["aIUsage"]>;
...
export type AIUsageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<AIUsageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AIUsageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['AIUsage'];
        meta: {
            name: 'AIUsage';
        };
    };
     ...
     * })
    **/
    count<T extends AIUsageCountArgs>(args?: Prisma.Subset<T, AIUsageCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], AIUsageCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends AIUsageGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, AIUsageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAIUsageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface AIUsageFieldRefs {
    ...
    readonly dateJour: Prisma.FieldRef<"AIUsage", 'String'>;
    readonly requetes: Prisma.FieldRef<"AIUsage", 'Int'>;
    readonly tokensUtilises: Prisma.FieldRef<"AIUsage", 'Int'>;
}
/**
 * AIUsage findUnique
 */
